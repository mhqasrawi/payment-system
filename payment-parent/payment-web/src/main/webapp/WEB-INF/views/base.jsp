...
<div class="well" style="width: 400px; padding: 8px 0;">
	<div style="overflow-y: scroll; overflow-x: hidden; height: 600px;">
		<ul class="nav nav-list">
        			<li><label class="tree-toggler nav-header">Show Account Info</label>
				<ul class="nav nav-list tree">
					<li><a href="/accountInfo?accountNumber=${account.getAccountNumber()}"> Account Info</a></li>
				</ul></li>
			<li class="divider"></li>
			<li><label class="tree-toggler nav-header">Update Account</label>
				<ul class="nav nav-list tree">
					<li><a href="#">Edit Account Type</a></li>
				</ul></li>
			<li class="divider"></li>
			<li><label class="tree-toggler nav-header">Create New Payment</label>
				<ul class="nav nav-list tree">
					<li><a href="#">Create Payment</a></li>
				</ul></li>
                <li class="divider"></li>
                <li><label class="tree-toggler nav-header">Generate Report</label>
				<ul class="nav nav-list tree">
					<li><a href="#">Generate Report</a></li>
				</ul></li>
				  <li class="divider"></li>
                <li><label class="tree-toggler nav-header">New Payment Purpose</label>
				<ul class="nav nav-list tree">
