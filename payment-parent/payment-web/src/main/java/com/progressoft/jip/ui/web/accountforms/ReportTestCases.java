...
public class ReportTestCases {
	...
	private static List<PaymentDTO> payments = new LinkedList<>();
	...
	public Iterable<PaymentDTO> getMockPayments() {
		setup();
		return payments;
	}
	...
	public void callingGenerateReportMethod_WithNullSettings_ShouldThrowNullPointerException()
			throws ReportManagerException {
		reportManager.generateReport(null);
	}

	public void callingGenerateReportMethod_WithNullSettingsParams_ShouldThrowNullPointerException()
			throws ReportManagerException {
	...
	public void callingGenerateReportMethod_WithEmptySettingsParams_ShouldThrowReportManagerException()
			throws ReportManagerException {
		ReportSettingsImpl settings = new ReportSettingsImpl();
